...
const OwnableBin = ``
...
// ServiceManagerBin is the compiled bytecode used for deploying new contracts.
const ServiceManagerBin = ``

// DeployServiceManager deploys a new Ethereum contract, binding an instance of ServiceManager to it.
func DeployServiceManager(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *ServiceManager, error) {
	parsed, err := abi.JSON(strings.NewReader(ServiceManagerABI))
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	address, tx, contract, err := bind.DeployContract(auth, parsed, common.FromHex(ServiceManagerBin), backend)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &ServiceManager{ServiceManagerCaller: ServiceManagerCaller{contract: contract}, ServiceManagerTransactor: ServiceManagerTransactor{contract: contract}, ServiceManagerFilterer: ServiceManagerFilterer{contract: contract}}, nil
}
